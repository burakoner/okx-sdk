...
ACCOUNT_ADJUST_LEVERAGE_INFO = '/api/v5/account/adjust-leverage-info' # TODO
...
ACCOUNT_QUICK_MARGIN_BORROW_REPAY = '/api/v5/account/quick-margin-borrow-repay' # TODO
ACCOUNT_QUICK_MARGIN_BORROW_REPAY_HISTORY = '/api/v5/account/quick-margin-borrow-repay-history' # TODO
...
ACCOUNT_POSITION_BUILDER = '/api/v5/account/position-builder' # TODO
...
ACCOUNT_SET_ACCOUNT_LEVEL = '/api/v5/account/set-account-level' # TODO
ACCOUNT_MMP_RESET = '/api/v5/account/mmp-reset' # TODO
ACCOUNT_SET_MMP_CONFIG = '/api/v5/account/mmp-config' # TODO
ACCOUNT_GET_MMP_CONFIG = '/api/v5/account/mmp-config' # TODO
...
TRADE_APPLY_ORDERS_FILLS_ARCHIVE = '/api/v5/trade/fills-archive' # TODO
TRADE_RETRIEVE_ORDERS_FILLS_ARCHIVE = '/api/v5/trade/fills-archive' # TODO
...
TRADE_MASS_CANCEL = '/api/v5/trade/mass-cancel' # TODO
TRADE_CANCEL_ALL_AFTER = '/api/v5/trade/cancel-all-after' # TODO
TRADE_ACCOUNT_RATE_LIMIT = '/api/v5/trade/account-rate-limit' # TODO
...
GRID_CLOSE_POSITION = '/api/v5/tradingBot/grid/close-position' # TODO
GRID_CANCEL_CLOSE_ORDER = '/api/v5/tradingBot/grid/cancel-close-order' # TODO
...
GRID_MIN_INVESTMENT = '/api/v5/tradingBot/grid/min-investment' # TODO
GRID_RSI_BACK_TESTING = '/api/v5/tradingBot/public/rsi-back-testing' # TODO
...
MARKET_HISTORY_INDEX_CANDLES = '/api/v5/market/history-index-candles' # TODO
MARKET_MARK_PRICE_CANDLES = '/api/v5/market/mark-price-candles'
MARKET_HISTORY_MARK_PRICE_CANDLES = '/api/v5/market/history-mark-price-candles' # TODO
...
PUBLIC_ECONOMIC_CALENDAR = '/api/v5/public/economic-calendar' # TODO

# Market Data Endpoints
MARKET_TICKERS = '/api/v5/market/tickers'
MARKET_TICKER = '/api/v5/market/ticker'
MARKET_BOOKS = '/api/v5/market/books'
MARKET_BOOKS_FULL = '/api/v5/market/books-full' # TODO
...
RFQ_SET_MMP_CONFIG = '/api/v5/rfq/mmp-config' # TODO
RFQ_GET_MMP_CONFIG = '/api/v5/rfq/mmp-config' # TODO
...
SPREAD_AMEND_ORDER = '/api/v5/sprd/amend-order' # TODO
...
SPREAD_ORDERS_HISTORY_ARCHIVE = '/api/v5/sprd/orders-history-archive' # TODO
...
ASSET_EXCHANGE_LIST = '/api/v5/asset/exchange-list' # TODO
ASSET_MONTHLY_STATEMENT_01 = '/api/v5/asset/monthly-statement' # TODO
ASSET_MONTHLY_STATEMENT_02 = '/api/v5/asset/monthly-statement' # TODO
...
ACCOUNT_SUBACCOUNT_MAX_WITHDRAWAL = '/api/v5/account/subaccount/max-withdrawal' # TODO
ASSET_SUBACCOUNT_BILLS = '/api/v5/asset/subaccount/bills'
ASSET_SUBACCOUNT_MANAGED_SUBACCOUNT_BILLS = '/api/v5/asset/subaccount/managed-subaccount-bills' # TODO
...
FINANCE_STACKING_DEFI_ETH_PURCHASE = '/api/v5/finance/staking-defi/eth/purchase' # TODO
FINANCE_STACKING_DEFI_ETH_REDEEM = '/api/v5/finance/staking-defi/eth/redeem' # TODO
FINANCE_STACKING_DEFI_ETH_BALANCE = '/api/v5/finance/staking-defi/eth/balance' # TODO
FINANCE_STACKING_DEFI_ETH_PURCHASE_REDEEM_HISTORY = '/api/v5/finance/staking-defi/eth/purchase-redeem-history' # TODO
FINANCE_STACKING_DEFI_ETH_APY_HISTORY = '/api/v5/finance/staking-defi/eth/apy-history' # TODO
...
BROKER_ND_SUBACCOUNT_WITHDRAWAL_HISTORY_01 = '/api/v5/asset/broker/nd/subaccount-withdrawal-history' # TODO
BROKER_ND_SUBACCOUNT_WITHDRAWAL_HISTORY_02 = '/api/v5/asset/broker/nd/subaccount-withdrawal-history' # TODO
...
BROKER_FD_IF_REBATE = '/api/v5/broker/fd/if-rebate' # TODO
